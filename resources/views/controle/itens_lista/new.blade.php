...
<div class="row">
    <div class="col s12 m6 push-m3">
        <h3 class="light">Cadastrar item</h3>
        <form action="{{ route('item_controle.store') }}" method="POST">
            @csrf
            <input type="hidden" name="lista_controle_id" value="{{ $lista->id }}">
            ...
            <div class="input-field col s4">
                <input type="date" name="vencimento_boleto" required>
